<main>
    <nav class="nav">
        <ul class="nav__list container">
            <li class="nav__item">
                <a href="index.php">Доски и лыжи</a>
            </li>
            <li class="nav__item">
                <a href="index.php">Крепления</a>
            </li>
            <li class="nav__item">
                <a href="index.php">Ботинки</a>
            </li>
            <li class="nav__item">
                <a href="index.php">Одежда</a>
            </li>
            <li class="nav__item">
                <a href="index.php">Инструменты</a>
            </li>
            <li class="nav__item">
                <a href="index.php">Разное</a>
            </li>
        </ul>
    </nav>
